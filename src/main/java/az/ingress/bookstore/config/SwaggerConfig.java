...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    public Docket swaggerSettings() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .produces(Stream.of(MediaType.APPLICATION_JSON_VALUE,
                        ...
                        .collect(Collectors.toSet()))
                .select()
                .apis(RequestHandlerSelectors.basePackage("az.ingress.bookstore.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Tour and Travel Agencies",
                ...
                new Contact("Nebiyev Ismayil",
                        "https://github.com/ISKANBV",
                        "nabiyevismayil6@gmail.com"),
                "License of API",
